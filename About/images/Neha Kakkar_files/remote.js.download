...
g.$c(a,"https://www.gstatic.com/cv/js/sender/v1/cast_sender.js");a=a.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+g.Cb(a)},wBa=function(a,b){var c=g.Ed("SCRIPT");
...
g.ad(c,g.de("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"));var d=window.document.getElementsByTagName("head")[0]||window.document.body;d.insertBefore(c,d.firstChild);return c},xBa=function(){var a=vBa(),b=window.document.getElementById(a),c=b&&g.gF(b,"loaded");
...
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;zBa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",x6,c)}},CBa=function(){var a=window.__gCrWeb&&window.__gCrWeb.message&&window.__gCrWeb.message.invokeOnHost;
a&&(A6(),a({command:"cast.sender.init"}))},DBa=function(){A6();
var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);w6(["//www.gstatic.com/eureka/clank/"+(a?(0,window.parseInt)(a[1],10):0)+y6,"//www.gstatic.com/eureka/clank"+y6])},B6=function(a,b,c){g.K.call(this);
...
a.rd&&(c=null);var d=(0,g.z)(a.VU,a);c||(c=new g.Bm("//www.google.com/images/cleardot.gif"),f6(c));MBa(c.toString(),1E4,d)}else H6(2);cCa(a,b)},cCa=function(a,b){a.g=0;
